...
int main() {
	...
	//AUTOS
	cAutomovil* RayoMcqueen = new cAutomovil(eEstadoVehiculo::DISPONIBLE, 1000, eColor::ROJO, "CHASIS1", "AA 111 AA", "POLIZA1", FECHA, 4);
	cAutomovil* Herbie = new cAutomovil(eEstadoVehiculo::DISPONIBLE, 500, eColor::BLANCO, "CHASIS2", "AA 222 AB", "POLIZA2", FECHA, 4);
	cAutomovil* BatiMovil = new cAutomovil(eEstadoVehiculo::DISPONIBLE, 5000, eColor::NEGRO, "CHASIS3", "AA 333 AC", "POLIZA3", FECHA, 4);

	//CAMIONETAS
	cCamioneta* Mate = new cCamioneta(eEstadoVehiculo::EN_MANTENIMIENTO, 700, eColor::GRIS, "CHASIS4", "BB 444 AD", "POLIZA4", FECHA, 7);
	cCamioneta* DeLorean = new cCamioneta(eEstadoVehiculo::DISPONIBLE, 750, eColor::GRIS, "CHASIS5", "BB 555 AE", "POLIZA5", FECHA, 7);
	cCamioneta* March5 = new cCamioneta(eEstadoVehiculo::EN_MANTENIMIENTO, 800, eColor::BLANCO, "CHASIS6", "BB 666 AF", "POLIZA6", FECHA, 7);

	//TRAFIC
	cTrafic* Dusty = new cTrafic(eEstadoVehiculo::DISPONIBLE, 2000, eColor::AZUL, "CHASIS8", "CC 888 AH", "POLIZA8", FECHA, 10);

	//MOTOS
	cMotocicleta* Vespa = new cMotocicleta(eEstadoVehiculo::DISPONIBLE, 100, eColor::NEGRO, "CHASIS9", "DD 999 AI", "POLIZA9", FECHA, 1);
	cMotocicleta* HarleyDavidson = new cMotocicleta(eEstadoVehiculo::DISPONIBLE, 150, eColor::NEGRO, "CHASIS10", "DD 110 AJ", "POLIZA10", FECHA, 1);
